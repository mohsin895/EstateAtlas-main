...
const DataCard = ({
  ...
  const opacityClass =
    opacity === 'medium' ? 'opacity-70 scale-[0.92]' : 'scale-100';
  ...
  const yieldColorClass = highlighted
    ? 'text-sky-400'
    : 'text-sky-500/70';
    ...
    <div className={`relative transition-all duration-300 ${opacityClass}`}>
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <span
            className={`text-base font-bold tracking-wide ${textColorClass}`}
          >
            {city}
          </span>
        </div>
  ...
  return (
    <div className="relative min-h-screen w-full pt-[112px] overflow-hidden bg-[#0A1532]">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 right-20 w-32 h-32 border border-sky-500/10 rotate-45" />
        <div className="absolute bottom-40 left-1/4 w-48 h-48 border border-sky-500/15 rounded-lg rotate-12" />
      </div>
