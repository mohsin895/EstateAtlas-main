  ...
  return (
    <div className=" mx-auto">
      ...
      <div className="md:container mx-auto  md:mb-40 mb-7 md:p-8 p-2 text-[#0A1532] text-center space-y-10">
        ...
        <Link href={'/auth/register'} className="md:px-10 px-6 py-5 mt-12 bg-[#0A1532] text-white md:text-2xl text-xl font-semibold rounded-xl">
          Explore Global Data
        </Link>
      </div>
...
></div>
      ...
      <section className="border-y-2  border-dashed  py-5">
        ...
        <section className="grid lg:grid-cols-2 grid-cols-1 gap-4 lg:gap-20 mt-20 mb-10 md:container lg:px-20 px-5 mx-auto">
