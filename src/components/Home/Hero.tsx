...
const Hero = () => {
  ...
  return (
    <div className="relative  md:h-[1000px] md:pb-1 pb-10 w-full overflow-hidden bg-[#0A1532]">
      ...
      <div
        className=" absolute hidden md:flex bottom-0 left-0 w-full h-80 bg-white z-10"
        style={{
      ...
      <div className="relative md:container mx-auto z-20 md:p-8 p-2 text-white text-center space-y-10">
        ...
        <Link href={'/auth/register'} className="md:px-10 px-6 py-5 mt-20 bg-white text-[#0A1532] md:text-2xl text-xl font-semibold rounded-xl">
          Explore Global Data
        </Link>
      </div>
     ...
     <div
  className="absolute md:flex hidden bottom-5 left-1/2 transform -translate-x-1/2 z-100 drop-shadow-xl"
